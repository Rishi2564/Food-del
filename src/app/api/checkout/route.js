...
export async function POST(req) {
  ...
  for (const cartProduct of cartProducts) {
    ...
    // ensure Stripe INR minimum – force min ₹50 per product
    productPrice = Math.max(productPrice, 50);
    ...
    shipping_options: [
      {
        shipping_rate_data: {
          ...
          type: "fixed_amount",
          // Stripe requires paisa → ×100
          fixed_amount: { amount: 5000, currency: "INR" }, // ₹50
        },
      }
    ],
  });
